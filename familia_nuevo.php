...
<html>
    <head>
        ...
        <title>Sistema de Ventas y Almacén - Overware - Familias</title>
    ...
    <body>
        <div class="maincontent">
            <div class="contentinner widgetcontent">
                ...
                <form class="stdform" action="familia_guardar.php" method="post">
                    <p>
                    ...
                    <p>
                        <label>Área</label>
                        <span class="field">
                            <select name="area" class="uniformselect">
                            <?php
                            $query = "select id, descripcion from areas where estado = 1 order by descripcion";
