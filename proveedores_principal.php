                ...
                <div class="row-fluid">
                	<div class="span8">
                    	<ul class="widgeticons row-fluid">
                            <li class="one_fifth"><a href="proveedores_nuevo.php"><img src="img/gemicon/Add-icon.png" alt="" /><span>Nuevo Proveedor</span></a></li>
                            <li class="one_fifth"><a href="proveedores_editar.php"><img src="img/gemicon/Edit-icon.png" alt="" /><span>Editar Proveedor</span></a></li>
                        </ul>
                    </div><!--span8-->
                </div><!--row-fluid-->
            </div><!--contentinner-->
