...
<div class="mainwrapper">
    ...
    <div class="rightpanel">
      ...
      <div class="pagetitle">
          <h1>Guardar Edición de Artículo</h1> <span></span><!--sample description for dashboard page...-->
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
            <div class="contentinner widgetcontent">
                ...
                $query = "update articulo set cod_barra='$cod_barras', descripcion='$descripcion', descripcion_corta='$descripcion_corta', familia=$id_familia, cantidad_paquete=$cantidad_paquete, marca=$id_marca, observacion='$observacion', estado=$estado where id=$articulo_id";
                if($rs = mysqli_query($db_cn, $query)){
                    echo 'El artículo se ha editado correctamente';
                }else{
                    echo 'Hubo un error en el guardado';
                }
                ?>
                <br><br>
                <a class="btn btn-primary" href="articulo_editar.php">Regresar</a>
