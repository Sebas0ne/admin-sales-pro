                ...
                <div class="row-fluid">
                	<div class="span8">
                    	<ul class="widgeticons row-fluid">
                            <li class="one_fifth"><a href="articulo_nuevo.php"><img src="img/gemicon/Add-icon.png" alt="" /><span>Nuevo Artículo</span></a></li>
                            <li class="one_fifth"><a href="articulo_editar.php"><img src="img/gemicon/Edit-icon.png" alt="" /><span>Editar Artículo</span></a></li>
                        </ul>
                    </div><!--span8-->
                </div><!--row-fluid-->
            </div><!--contentinner-->
