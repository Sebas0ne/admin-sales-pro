    ...
    <body>
        <div class="maincontent">
            <div class="contentinner widgetcontent">
                ...
                $area        = $_POST["area"];
                $query = "insert into familia(descripcion,observacion,area) values ('$descripcion','$observacion',$area);";
                if($res = mysqli_query($db_cn, $query)){
                    echo 'La familia ha sido guardada correctamente. Cierre esta ventana.';
                }else{
