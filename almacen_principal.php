...
<title>Sistema de Ventas y Almacén - Overware - Ingreso a Almacén</title>
                ...
                <div class="row-fluid">
                    <div class="span8">
                    	<ul class="widgeticons row-fluid">
                            <li class="one_fifth"><a href="almacen_entrada.php"><img src="img/gemicon/dolly-icon.png" alt="" /><span>Entrada a Almacén</span></a></li>
                            <li class="one_fifth"><a href="almacen_editarlotes.php"><img src="img/gemicon/compose-icon.png" alt="" /><span>Editar Lotes</span></a></li>
                            <li class="one_fifth"><a href="almacen_salida.php"><img src="img/gemicon/running-icon.png" alt="" /><span>Salida de Artículos (no venta)</span></a></li>
                        </ul>
                    </div><!--span8-->
                </div><!--row-fluid-->
            </div><!--contentinner-->
