      ...
      <div class="pagetitle">
        ...
        <div class="maincontent">
            <div class="contentinner widgetcontent">
                ...
                $query = "insert into proveedor (nombre, ruc, direccion, telefono, correo, nombre1, telefono1, correo1, nombre2, telefono2, correo2, nombre3, telefono3, correo3, fecha_registro) values "
                        . "('$nombre','$ruc','$direccion','$telefono','$correo','$nombre1','$telefono1','$correo1','$nombre2','$telefono2','$correo2','$nombre3','$telefono3','$correo3',now())";
                
                if($rs = mysqli_query($db_cn, $query)){
                    echo 'El proveedor se ha guardado correctamente<br>';
                }else{
                    echo 'Hubo un error en el guardado<br>';
                }
                ?>
                
                <a class="btn btn-primary" href="proveedores_principal.php">Regresar</a>
            </div>
