      ...
      <div class="pagetitle">
        ...
        <div class="maincontent">
            <div class="contentinner widgetcontent">
                <?php
                    //recibiendo datos
                    $nuevo_nombre = $_POST["nombreempresa"];
                    $nuevo_ruc = $_POST["rucempresa"];
                    $nuevo_direccion = $_POST["direccionempresa"];
                    $nuevo_telefono = $_POST["telefonoempresa"];
                    $nuevo_igv = $_POST["igv"];
                    
                    //preparando la query
                    $query = "update empresa set nombre = '$nuevo_nombre', ruc = '$nuevo_ruc', telefono = '$nuevo_telefono', direccion = '$nuevo_direccion', igv=$nuevo_igv";
                    if($res = mysqli_query($db_cn, $query)){
                        echo 'Los datos se guardaron correctamente.';
                    }else{
                        echo 'Hubo un error en el guardado de datos.';
                    }
                    
                    $query = "select nombre, estado, DATE_FORMAT(fecha_vencimiento, ".'"%d/%m/%Y"'.") as vencimiento, ruc, direccion, telefono, igv from empresa";//debería ser un solo registro
